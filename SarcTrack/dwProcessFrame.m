...
path = '/Users/BamBam/Desktop/Example3.avi';
frameIndex = 1;

ds = 6:0.2:18; % range of distances (in pixels)
stretch = 1.5; % stretch of morlet wavelet
...
[M3,A3,X3,Y3] = coefficientsmatrix23(I,ds,...
    'NumAngles',nangs,...
    'WavStretch',stretch,...
    'WavScale',scale,...
