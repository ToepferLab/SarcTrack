...
ds = 8:0.2:16; % range of distances (in pixels)
stretch = 1.2; % stretch of morlet wavelet
scale = 2.5; % scale of morlet wavelet
nangs = 4;
hopsize = 22;
halfwindowsize = 8;
magthreshold = [];
...
% [f,n] = fileparts(path);
% % save([f filesep n '_cM.mat'], 'cM');
% % save([f filesep n '_cA.mat'], 'cA');
% % save([f filesep n '_cX.mat'], 'cX');
% % save([f filesep n '_cY.mat'], 'cY');
% load([f filesep n '_cM.mat'], 'cM');
% load([f filesep n '_cA.mat'], 'cA');
% load([f filesep n '_cX.mat'], 'cX');
% load([f filesep n '_cY.mat'], 'cY');
% nFrames = length(cM);
